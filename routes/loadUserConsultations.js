...
router.post('/loadUserConsultations', (req, res) => {
    ...
    const query = 'SELECT Consultations.consultation_id, Consultations.consultation_date, ConsStatus.consultation_status, Doctors.doctor_name FROM Consultations ' +
